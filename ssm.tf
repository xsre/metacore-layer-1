...
data "aws_subnet" "vpc_private_subnet_0" {
  ...
  filter {
    name   = "tag:Name"
    values = ["*${var.infra_id}*-*${var.env}*private-${var.region}a"]
  }
}
...
data "aws_subnet" "vpc_private_subnet_1" {
  ...
  filter {
    name   = "tag:Name"
    values = ["*${var.infra_id}*-*${var.env}*private-${var.region}b"]
  }
}
...
data "aws_subnet" "vpc_private_subnet_2" {
  ...
  filter {
    name   = "tag:Name"
    values = ["*${var.infra_id}*-*${var.env}*private-${var.region}c"]
  }
}
...
data "aws_subnet" "vpc_public_subnet_0" {
  ...
  filter {
    name   = "tag:Name"
    values = ["*${var.infra_id}*-*${var.env}*public-${var.region}a"]
  }
}
...
data "aws_subnet" "vpc_public_subnet_1" {
  ...
  filter {
    name   = "tag:Name"
    values = ["*${var.infra_id}*-*${var.env}*public-${var.region}b"]
  }
}
...
data "aws_subnet" "vpc_public_subnet_2" {
  ...
  filter {
    name   = "tag:Name"
    values = ["*${var.infra_id}*-*${var.env}*public-${var.region}c"]
  }
}
